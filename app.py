...
def calculate_mid():
    if request.method == "POST":
        ...
        result = (round (calc, 2))
        return render_template("exchange.html", result = result, choice_have_currency=choice_have_currency, choice_quantity=choice_quantity, choice_want_currency=choice_want_currency, currency_want_value=currency_want_value, heading=heading)       
